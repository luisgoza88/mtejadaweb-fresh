...
interface CasaAlterraDetailProps {
  projectId: string;
}

function CasaAlterraDetail({ projectId }: CasaAlterraDetailProps) {
  ...
  // Imágenes del proyecto Casa Alterra
  const projectImages = [
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/CASA%20ALTERRA/WhatsApp%20Image%202025-09-15%20at%2017.56.05.jpeg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/CASA%20ALTERRA/Captura%20de%20pantalla%202025-09-15%20a%20la(s)%206.02.54%20p.m..png',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/CASA%20ALTERRA/Captura%20de%20pantalla%202025-09-15%20a%20la(s)%206.03.06%20p.m..png',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/CASA%20ALTERRA/Captura%20de%20pantalla%202025-09-15%20a%20la(s)%206.03.22%20p.m..png',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/CASA%20ALTERRA/WhatsApp%20Image%202025-09-15%20at%2017.56.05%20(1).jpeg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/CASA%20ALTERRA/WhatsApp%20Image%202025-09-15%20at%2017.56.05%20(2).jpeg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/CASA%20ALTERRA/WhatsApp%20Image%202025-09-15%20at%2017.56.05%20(3).jpeg'
  ];
            ...
            <div className="lg:w-2/3 p-4 lg:p-8">
              ...
              <div className="mb-6 relative overflow-hidden">
                <img 
                  ...
                  alt={`Casa Alterra - Vista ${selectedImage + 1}`}
              ...
              <div className="sticky top-32">
                ...
                <div className="mb-8">
                  <p className="text-sm font-source-code text-gray-600 mb-2">
                    RESIDENCIAL • ALTO DE LAS PALMAS • EN CONSTRUCCIÓN
                  </p>
                ...
                <div className="space-y-6 text-sm md:text-base font-dm-sans text-gray-700 leading-relaxed">
                  <p>
                    Casa Alterra se concibe como un proyecto arquitectónico que busca la perfecta armonía entre los espacios diseñados para un entorno familiar y la integración con el paisaje natural del Alto de las Palmas. La arquitectura abraza la topografía del terreno, creando una composición volumétrica que dialoga respetuosamente con su contexto.
                  </p>
                  
                  <p>
                    Los espacios familiares fluyen naturalmente hacia terrazas y jardines, generando una experiencia habitacional que celebra la vida en familia en un entorno privado y sereno. Las áreas comunes se extienden hacia el exterior a través de grandes ventanales y espacios de transición que difuminan los límites entre interior y exterior.
                  </p>

                  <p>
                    La materialidad se basa en elementos nobles como piedra natural, madera y concreto expuesto, que se integran orgánicamente con la vegetación nativa. El diseño bioclimático aprovecha la orientación solar y los vientos predominantes, mientras que la paleta de materiales locales refuerza la conexión con el territorio montañoso de Antioquia.
                  </p>
                </div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-300">
                  ...
                  <dl className="space-y-2 text-sm font-source-code">
                    <div className="flex justify-between">
                      ...
                      <dd className="text-black">217 m²</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-600">Estado:</dt>
                      <dd className="text-black">En construcción</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-600">Año:</dt>
                      <dd className="text-black">2025</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-600">Ubicación:</dt>
                      <dd className="text-black">Alto de las Palmas, Antioquia</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-600">Tipo:</dt>
                      <dd className="text-black">Casa de Retiro</dd>
                    </div>
                  </dl>
                </div>
              </div>
...
export default CasaAlterraDetail;