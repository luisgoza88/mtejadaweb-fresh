...
function ProjectDetail({ projectId }: ProjectDetailProps) {
  ...
  // Imágenes del proyecto Oficina BIO26
  const projectImages = [
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/049-MSPH8638.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/006-MSPH8544.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/037-MSPH8612.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/046-MSPH8633.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/055-MSPH8652.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/076-MSPH8694.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/085-MSPH8720.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/090-MSPH8728.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/103-MSPH8744.jpg'
  ];
            ...
            <div className="lg:w-1/3 p-4 lg:p-8 bg-gray-50">
              <div className="sticky top-32">
                ...
                <div className="space-y-6 text-sm md:text-base font-dm-sans text-gray-700 leading-relaxed">
                  <p>
                    Un espacio de trabajo contemporáneo que redefine la experiencia corporativa a través de una arquitectura fluida y orgánica. La Oficina BIO26 se caracteriza por sus líneas curvas y su paleta de materiales naturales que crean un ambiente sereno y productivo.
                  </p>
                  
                  <p>
                    El diseño prioriza la luz natural, con amplios ventanales que enmarcan vistas urbanas mientras filtran la iluminación a través de elementos arquitectónicos cuidadosamente posicionados. Los espacios de trabajo colaborativo se entrelazan con áreas de concentración individual, logrando un equilibrio perfecto entre funcionalidad y estética.
                  </p>
                </div>
