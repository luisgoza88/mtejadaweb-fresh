...
interface HotelDOS7DetailProps {
  projectId: string;
}

function HotelDOS7Detail({ projectId }: HotelDOS7DetailProps) {
  ...
  // Imágenes del proyecto Hotel DOS7
  const projectImages = [
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/Fachada%201%20Noche.png',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/12.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/16.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/3.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/4.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/5.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/9.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/Cocina.jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/Sala%20(2).jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/Tipologia%201%20(habitacion)%20(1).jpg',
    'https://ehhvwmzxcjyupjdonkvl.supabase.co/storage/v1/object/public/projects/HOTEL%20DOS7/Tipologia%201%20(habitacion)%20(2).jpg'
  ];
            ...
            <div className="lg:w-2/3 p-4 lg:p-8">
              ...
              <div className="mb-6 relative overflow-hidden">
                <img 
                  ...
                  alt={`Hotel DOS7 - Vista ${selectedImage + 1}`}
            ...
            <div className="lg:w-1/3 p-4 lg:p-8 bg-gray-50">
              <div className="sticky top-32">
                ...
                <div className="space-y-6 text-sm md:text-base font-dm-sans text-gray-700 leading-relaxed">
                  <p>
                    Un proyecto que transmite tranquilidad porque está alejado del bullicio de Medellín—este es un hotel para que las personas vengan a descansar en etapas pequeñas y medianas. Fue diseñado para eso.
                  </p>
                  
                  <p>
                    Hotel DOS7 ofrece un escape íntimo de la vida urbana, diseñado cuidadosamente para viajeros que buscan retiros pacíficos. Cada espacio ha sido elaborado meticulosamente para promover el descanso y la renovación, presentando materiales cálidos y ambientes serenos que invitan a los huéspedes a desconectarse y relajarse.
                  </p>

                  <p>
                    La arquitectura abraza una filosofía de hotel boutique, con espacios personalizados que atienden a parejas y grupos pequeños. Desde habitaciones acogedoras hasta áreas comunes diseñadas para la contemplación silenciosa, cada detalle apoya la misión del hotel de brindar experiencias de descanso auténticas lejos de las demandas de la ciudad.
                  </p>
                </div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-300">
                  ...
                  <dl className="space-y-2 text-sm font-source-code">
                    <div className="flex justify-between">
                      ...
                      <dd className="text-black">650 m²</dd>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <dd className="text-black">Envigado, Antioquia</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-600">Tipo:</dt>
                      <dd className="text-black">Hotel Boutique</dd>
                    </div>
                  </dl>
                </div>
              </div>
...
export default HotelDOS7Detail;